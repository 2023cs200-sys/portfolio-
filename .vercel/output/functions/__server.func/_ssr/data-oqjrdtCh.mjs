//#region node_modules/.nitro/vite/services/ssr/assets/data-oqjrdtCh.js
var PERSONAL = {
...
var EXPERIENCE = [
	{
		...
		dates: "2024",
		location: "",
		bullets: ["Built a centralized event marketing platform for Sri Lankan universities enabling students to discover, manage, and engage with campus events", "Streamlined event promotion, registration, and communication through a single unified system"]
	},
	{
	...
	},
	{
		...
		dates: "2024",
		location: "",
		bullets: ["Developed an AI-powered chatbot with NLP capabilities for intelligent real-time customer interactions", "Built a seamless conversational experience using modern web technologies"]
	},
	{
		...
		dates: "2024",
		location: "",
		bullets: ["Built a secure messaging tool with Base64 encryption/decryption and a modern dark-themed UI", "Implemented real-time encryption, clipboard copying, and password-protected access"]
	},
	{
...
//#endregion
export { EXPERIENCE as a, PERSONAL as c, SKILL_CARDS as d, CV_SUMMARY as i, POSTS as l, CERTS as n, JOURNEY as o, CONTACTS as r, LANGUAGES as s, ACADEMIC as t, PROJECTS as u };
